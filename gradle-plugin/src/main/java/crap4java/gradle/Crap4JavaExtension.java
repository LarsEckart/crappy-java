...
/** {@code crap4java { ... }} block. Values become the conventions of the {@code crap} task. */
public class Crap4JavaExtension {
    ...
    @Inject
    public Crap4JavaExtension(ObjectFactory objects) {
